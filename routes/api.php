...
Route::post('directpendingprescribe',[API\PrescriptionController::class,'directpendingPrescribe']);
...
Route::get('listtabletdrugs',[API\DrugController::class,'tabletlist']);
Route::get('listinjectiondrugs',[API\DrugController::class,'injectionlist']);
Route::get('listliquiddrugs',[API\DrugController::class,'liquidlist']);
Route::get('listinhalationdrugs',[API\DrugController::class,'inhalationlist']);
Route::get('listoralliquiddrugs',[API\DrugController::class,'oralliquidlist']);
Route::get('listpfidrugs',[API\DrugController::class,'pfilist']);
Route::get('listotherdrugs',[API\DrugController::class,'otherlist']);
