...
let routes = [
    ...
    { path: '/consultbill', component: require('./components/ConsultationBill.vue').default },
    { path: '/labtestbill', component: require('./components/LabTestBill.vue').default },
    { path: '/drugbill', component: require('./components/DrugBill.vue').default },
