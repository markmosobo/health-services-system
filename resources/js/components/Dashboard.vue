<template>
    <div class="container mt-3"> 
        ...
        <div v-if="$gate.isStaff()" class="card">
            ...
            <!-- /.card -->
            <div v-if="$gate.isSuperAdminOrAdmin()" class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div v-if="$gate.isSuperAdminOrAdmin()" class="position-relative mb-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas id="sales-chart" height="200" style="display: block; width: 479px; height: 200px;" width="479" class="chartjs-render-monitor"></canvas>
                </div>

                <div v-if="$gate.isSuperAdminOrAdmin()" class="d-flex flex-row justify-content-end">
                  <span class="mr-2">
                    <i class="fas fa-square text-primary"></i> This year
                  </span>
