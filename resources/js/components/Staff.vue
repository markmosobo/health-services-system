          ...
          <div class="col-12">
            <div class="card">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr v-for="staff in staffs.data" :key="staff.id">
                      ...
                      <td>{{staff.name}}</td>
                      <td>{{staff.email}}</td>
                      <td>{{staff.created_at | monthDateTime}}</td>
                      <td>
              ...
              <div class="card-footer clearfix" style="display: block;">
                <pagination :data="staffs" @pagination-change-page="getResults">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                            ...
                            <label>Bio</label>  
                                    ...
                                    name="bio" placeholder="Short bio for staff(optional)" class="form-control">
                                    </textarea>
...
<script>
    export default {
        ...
        methods: {
            getResults(page = 1) {
              this.$Progress.start();  
              axios.get('api/staff?page=' + page).then(({ data }) => (this.staffs = data));
              ...
              updatestaff(){
                  ...
                  .then(() => {
                    ...
                    Swal.fire(
                    'Updated!',
                    "staff's information has been updated.",
                    'success'
                    )
                    Fire.$emit('Refresh');
                  })
        ...
        mounted() {
            this.loadstaffs();
            Fire.$on('Refresh',() => {this.loadstaffs();})
        }
    }
</script>
